...
export default function DashboardCom() {
  ...
  const progressData = [
    { groupName: "Pak Halim", status: "Sedang Dibersihkan", location: "AEON Jakarta", date: "24-04-2025" },
    { groupName: "Bu Sri", status: "Sedang Dibersihkan", location: "Kemanggisan", date: "24-04-2025" },
    { groupName: "Bu Sri", status: "Menunggu Diterima", location: "Senayan", date: "24-04-2025" },
    { groupName: "Bu Sri", status: "Menunggu Diterima", location: "Petamburan", date: "24-04-2025" },
  ];
  ...
  const sedangDibersihkan = progressData.filter((item) => item.status === "Sedang Dibersihkan");
  const menungguDiterima = progressData.filter((item) => item.status === "Menunggu Diterima");
                ...
                <div className={styles.gridLayout}>
                  ...
                  <div className={styles.gridColumn}>
                    <div className={`${styles.card} ${styles.cardWithPadding}`}>
                      <h3 className={`${styles.cardTitle} ${styles.borderBottom}`}>Permintaan Terbaru</h3>
                      <div className={styles.cardContent}>
                        {menungguDiterima.length > 0 ? menungguDiterima.map((item, index) => <ProgressItem key={index} avatar={ImgCreator} {...item} isShowButton />) : <p className={styles.italicText}>Belum ada laporan baru masuk.</p>}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className={styles.gridColumn}>
                    <div className={`${styles.card} ${styles.cardWithPadding}`}>
                      ...
                      <div className={styles.cardContent}>
                        {sedangDibersihkan.length > 0 ? sedangDibersihkan.map((item, index) => <ProgressItem key={index} avatar={ImgCreator} {...item} />) : <p className={styles.italicText}>Belum ada laporan baru masuk.</p>}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className={styles.gridColumn}>
                    <div className={`${styles.card} ${styles.cardWithPadding}`}>
                      <h3 className={`${styles.cardTitle} ${styles.borderBottom}`}>Permintaan Relawan</h3>
                      <div className={styles.cardContent}>
