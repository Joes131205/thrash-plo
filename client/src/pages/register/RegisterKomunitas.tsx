...
export default function RegisterKomunitas() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await apiService.communities.register(
                communityData
            );
    ...
    const StepThree = () => {
        return (
            <>
                ...
                <TextInput
                    value={jmlAnggota}
                    onChange={(e) => setJmlAnggota(e.target.value)}
                    placeholder="Jumlah Anggota Komunitas"
                    type="anggota"
                    icon={IcListNumber}
                />
                <TextInput
            ...
            >
                <div className={styles.container}>
                    ...
                    <div className={styles.leftContent}>
                        ...
                        <div>
                            <h2
                                className={styles.titleMisi}
                                style={{ fontSize: isSmall ? "32px" : "50px" }}
                            >
                                Daftarkan Komunitasmu!
                            </h2>
                            <p className={styles.descMisi}>
                                Mulai aksi bersih hari ini dan jadilah bagian
                                dari perubahan
                            </p>
                        </div>
                    ...
                    <div className={styles.rightContent}>
                        ...
                        <div className={styles.textContent}>
                            <h4 className={styles.title}>
                                Gabungkan Kekuatan Bersama!
                            </h4>
                            <p className={styles.desc}>
                                Kelola laporan dan rencanakan aksi bersih dari
                                sini
                            </p>
                        </div>
                    </div>
